...
public class SliceBlade : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //
        // Renderer meshParentRenderer = _meshParent.GetComponentInChildren<Renderer>();
        // Material trailMaterial = Instantiate(meshParentRenderer.sharedMaterial);
        // trailMaterial.SetColor("Color_8F0C0815", _colour);
        // meshParentRenderer.sharedMaterial = trailMaterial;
        //
        // Renderer bladeRenderer = _blade.GetComponentInChildren<Renderer>();
        // Material bladeMaterial = Instantiate(bladeRenderer.sharedMaterial);
